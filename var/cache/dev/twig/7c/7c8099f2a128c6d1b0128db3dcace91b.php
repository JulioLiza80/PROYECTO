...
class __TwigTemplate_7454560a99f2b3dcb8279e177271ea6c extends Template
{
...
";
        ...
        // line 7
        if (CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["field"]) || array_key_exists("field", $context) ? $context["field"] : (function () { throw new RuntimeError('Variable "field" does not exist.', 7, $this->source); })()), "customOptions", [], "any", false, false, false, 7), "get", ["showSymbol"], "method", false, false, false, 7)) {
            // line 8
            yield "    <span class=\"badge badge-currency\" title=\"";
...
";
        ...
        // line 10
        if (CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, (isset($context["field"]) || array_key_exists("field", $context) ? $context["field"] : (function () { throw new RuntimeError('Variable "field" does not exist.', 10, $this->source); })()), "customOptions", [], "any", false, false, false, 10), "get", ["showName"], "method", false, false, false, 10)) {
            // line 11
            yield "    ";
...
";
    ...
    {
        return array (  70 => 11,  68 => 10,  60 => 8,  58 => 7,  50 => 5,  48 => 4,);
    }
...
{% endif %}
", "@EasyAdmin/crud/field/currency.html.twig", "C:\\Users\\stark\\Desktop\\optica\\kraken\\proyecto\\vendor\\easycorp\\easyadmin-bundle\\src\\Resources\\views\\crud\\field\\currency.html.twig");
    }
}
