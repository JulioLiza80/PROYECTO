...
class __TwigTemplate_f4e2b3da1f13b06f3f54178c815a3041 extends Template
{
    ...
    ";
        ...
        $_parent = $context['_parent'];
        unset($context['_seq'], $context['_iterated'], $context['_key'], $context['css_asset'], $context['_parent']);
        $context = array_intersect_key($context, $_parent) + $_parent;
...
{% for css_asset in assets %}
    ...
    {% endif %}
{% endfor %}
", "@EasyAdmin/includes/_css_assets.html.twig", "C:\\Users\\stark\\Desktop\\optica\\kraken\\proyecto\\vendor\\easycorp\\easyadmin-bundle\\src\\Resources\\views\\includes\\_css_assets.html.twig");
    }
}
